  ...
  useEffect(() => {
    ...
    obtenirDestinations
      ...
      .catch((e) => {
        ...
        setErreur("Erreur inattendue. Impossible d'obtenir les destinations !");
      })
    ...
    <div className="accueil-destination">
      ...
      <section className="destination-hero">
        <div className="destination-hero-overlay">
          <div className="destination-hero-content">
            ...
            <p>Explorez le monde et trouvez votre prochaine destination.</p>
      ...
      <section id="destinations" className="destinations-section">
        ...
        <form className="destination-filter">
          <label htmlFor="continent">Filtrer par continent :</label>

          <select
            id="continent"
            value={continentFiltre}
            onChange={(e) =>
              setContinentFiltre(e.target.value as Continent | "tous")
            }
          >
          ...
          {destinations.map((destination) => {
            ...
            return (
              <CardAccueilDestination
                ...
                drapeauEmoji={destination.infosupppays?.drapeau_emoji ?? ""}
                devise={destination.infosupppays?.devise ?? "Inconnue"}
                capitale={destination.infosupppays?.capitale ?? "Inconnue"}
                langage={destination.infosupppays?.langages ?? "Inconnue"}
                onVoirAvis={() => setSelectedDestinationId(destination.id)}
              />
            );
          })}
        </div>
