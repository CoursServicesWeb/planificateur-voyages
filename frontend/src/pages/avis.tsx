...
function AvisPage() {
    ...
    const avisFiltres = filtreVille
        ? avis.filter(
            (unAvis) => unAvis.sujet.ville === filtreVille
        )
        : avis;
                    ...
                    <div className="avis-liste">
                        ...
                        {avisFiltres.length === 0 ? (
                            ...
                            <div className="aucun-avis">
                                ...
                                <p>
                                    🌴 Aucun avis pour cette destination.
                                </p>
