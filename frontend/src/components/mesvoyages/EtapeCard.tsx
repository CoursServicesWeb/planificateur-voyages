...
export function EtapeCard({
  ...
  const [estOuvertModalModifierEtape, setEstOuvertModalModifierEtape] =
    useState<Boolean>(false);
  const [ouvrirModalSuppression, setOuvrirModalSuppression] =
    useState<Boolean>(false);

  const ouvrirModalModifierEtape = (
    ...
    <div className="col mt-4">
      <div className="card w-75 mx-auto h-100 position-relative">
        ...
        <div className="card-footer bg-transparent border-0 pt-0">
          <button
            type="button"
            onClick={ouvrirModalModifierEtape}
      ...
      {estOuvertModalModifierEtape && (
        <ModalModEtape
          ...
          onClose={() => setEstOuvertModalModifierEtape(false)}
        />
      )}
