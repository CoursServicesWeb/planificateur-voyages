...
export function ModalAjouterVoyage({
  onClose,
  handleCreateVoyage,
}: ModalModVoyProps) {
  ...
  const submitHandler = async (event: React.SubmitEvent<HTMLFormElement>) => {
    ...
    const postBody: Partial<CreateVoyage> =
      genererPOSTBodyCreerVoyage(formValues);
              ...
              <div className="modal-body">
                <div className="row g-3">
                  ...
                  <div className="col-md-6">
                    ...
                    />
                    <br />
                    <label htmlFor="hebergement-select" className="form-label">
                      Type hébergement
                    </label>
                    <br />
                    <select
